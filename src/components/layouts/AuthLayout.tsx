...
export function AuthLayout({
  ...
  return (
    <main className="flex min-h-screen items-center bg-slate-50 px-4 py-6 dark:bg-slate-950 sm:px-6 lg:px-8">
      <div className="mx-auto grid max-w-5xl overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-2xl shadow-slate-200/70 dark:border-slate-800 dark:bg-slate-900 dark:shadow-none lg:grid-cols-[0.9fr_1.1fr]">
